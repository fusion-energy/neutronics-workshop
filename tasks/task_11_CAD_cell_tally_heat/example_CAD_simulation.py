...
sett.dagmc = (
    True  # this is the openmc command enables use of the dagmc.h5m file as the geometry
)
...
my_plasma = Plasma(
    elongation=2.9, minor_radius=1.118, major_radius=1.9, triangularity=0.55
)
