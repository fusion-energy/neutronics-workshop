...
def add_trace_to_figure(figure, energy_bins, values, std_dev):
    ...
    figure.add_trace(
        go.Scatter(x=energy_bins, y=values + std_dev, line=dict(shape="hv", width=0))
    )
...
def create_plotly_figure(y_axis_label):
