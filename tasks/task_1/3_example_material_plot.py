...
# 60% Li6 by atom percentage
enriched_Li4SiO4 = openmc.Material()
enriched_Li4SiO4.add_element('Li', 4.0,
                             percent_type='ao',
                             enrichment=60,
...
enriched_Li4SiO4.set_density('g/cm3', 1.884)
...
Energy_natural_Li4SiO4_MT16, xs_data = openmc.calculate_cexs(natural_Li4SiO4,
                                                             'material',
                                                             Endf_MT_number)
cross_section_natural_Li4SiO4_MT16 = xs_data[0]

Energy_enriched_Li4SiO4_MT16, xs_data = openmc.calculate_cexs(enriched_Li4SiO4,
                                                              'material',
                                                              Endf_MT_number)
