...
def make_materials_geometry_tallies(enrichment_list, batches=2, inner_radius=500, thickness=100, breeder_material_name='Li', temperature_in_C=500):
...
x = [item*100 for sublist in x for item in sublist]
...
for filename_counter, coords in enumerate(x):
    ...
    results = make_materials_geometry_tallies(enrichment_list=coords, batches=2, inner_radius=500, thickness=100, breeder_material_name='Li', temperature_in_C=500)
...
for i in range(number_of_samples, number_of_samples+10):
    ...
    new_result = make_materials_geometry_tallies(enrichment_list=new_x, batches=2, inner_radius=500, thickness=100, breeder_material_name='Li', temperature_in_C=500)
    all_results.append(results)
